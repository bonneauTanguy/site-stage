        ...
        <div class="container-fluid">
			<form action="" method="post">
				<div class="form-group">
					<label>Nom</label>
					<input type="text" class="form-control" name="nomPrest" value="" required>
					<label>Tarif</label>
					<input type="text" class="form-control" name="prix" value=""required>
					<label>Année</label>
			...
			<?php
				...
				{
					$prestation = $_POST["nomPrest"];
					$tarif =$_POST["prix"];
					$date =$_POST["annee"];
					require("fonctionsSQL.php");
					$connexion = connexion ();
					$request = $connexion->prepare("INSERT INTO prestation (libelle) VALUES ('$prestation');");
					$request->execute();
					$request1 = $connexion->prepare("INSERT INTO tarifer (annee, prix) VALUES ('$date', '$tarif');");
					$request1->execute();
					$connexion = null;
					echo("Prestation ajouté");
				}
			?>
