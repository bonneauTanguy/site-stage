...
?></span>
		...
		<?php
			...
			$unAdherent = $curseurAdherents->fetch();
			...
			echo '<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
					<thead><tr>
						...
						<th colspan="1">tel1</th>
						<th colspan="1">tel2</th>
						<th colspan="1">frequenceVisite</th>
						<th colspan="1">id_type</th>
						<th colspan="1">id_coiffure</th>
					</tr></thead>
				<tbody>';
			while($unAdherent){
				echo "<tr> 
		...
		?>
		  <a href="ajoutClient.php" class="btn btn-light btn-icon-split">
