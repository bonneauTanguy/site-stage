        ...
        <div class="container-fluid">
			<form action="" method="post">
				<div class="form-group">
					...
					<button type="submit" class="btn btn-primary" id="ste" name="ste" value="insert">Créer</button>
				</div>
			</form>
			...
			<?php
				if(array_key_exists('ste',$_POST))
				{
					...
					$connexion = connexion ();
					$request = $connexion->prepare("INSERT INTO client (nomClient, prenomClient, tel1, tel2, id_type) VALUES ('$nom', '$pre', '$tel1', '$tel2', '$id');");
					$request->execute();
					$connexion = null;
					echo("Client créé");
				}
